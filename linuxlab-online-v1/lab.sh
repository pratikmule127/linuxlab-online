...
do
    ...
    case "$choice" in
        ...
        2) OS_NAME="CentOS"; IMAGE="centos/systemd:latest" ;;
        3) OS_NAME="Kali Linux"; IMAGE="kalilinux/kali-rolling:latest" ;;
        ...
        8) OS_NAME="Rocky Linux"; IMAGE="rockylinux/rockylinux:9" ;;
    ...
    # ✅ systemd special handling
    if [ "$IMAGE" = "centos/systemd:latest" ]; then
        docker run -dit \
            --privileged \
            --tmpfs /run \
            --tmpfs /run/lock \
